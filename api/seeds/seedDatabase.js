...
const destinosData = [
  {
    ...
    pais: "Argentina",
    descripcion: "Una de las maravillas naturales del mundo. Las Cataratas del Iguazú son un conjunto de cascadas espectaculares ubicadas en la frontera entre Argentina y Brasil. Con más de 275 saltos de agua, es un destino imperdible para los amantes de la naturaleza.",
  ...
  },
  {
    ...
    ciudad: "Cusco",
    pais: "Perú",
    descripcion: "Ciudad inca del siglo XV ubicada en lo alto de los Andes peruanos. Patrimonio de la Humanidad y una de las Siete Maravillas del Mundo Moderno. Un destino místico e histórico imprescindible.",
  ...
  },
  {
    ...
    pais: "Chile",
    descripcion: "Parque Nacional ubicado en la Patagonia chilena, conocido por sus imponentes montañas, glaciares azules, lagos turquesa y fauna silvestre. Un paraíso para los amantes del trekking y la aventura.",
    imagenPrincipal: "https://images.unsplash.com/photo-1601980861364-9f01d6de6c97",
    imagenes: [
      "https://images.unsplash.com/photo-1601980861364-9f01d6de6c97"
    ],
    precio: 200,
    ubicacion: {
      latitud: -50.9423,
  ...
  },
  {
    ...
    ciudad: "Cartagena",
    pais: "Colombia",
    descripcion: "Ciudad colonial en la costa caribeña de Colombia, famosa por sus murallas históricas, calles empedradas, arquitectura colorida y playas paradisíacas. Un destino perfecto para historia y playa.",
  ...
  },
  {
    ...
    ciudad: "Uyuni",
    pais: "Bolivia",
    descripcion: "El salar más grande del mundo con más de 10,000 km². Durante la temporada de lluvias se convierte en un espejo gigante que refleja el cielo, creando paisajes surrealistas únicos en el planeta.",
    imagenPrincipal: "https://images.unsplash.com/photo-1589394815804-964ed0be2eb5",
    imagenes: [
      "https://images.unsplash.com/photo-1589394815804-964ed0be2eb5"
    ],
...
async function seedDatabase() {
  try {
    ...
    const reseña1 = new Reseña({
      ...
      calificacion: 5,
      comentario: "¡Increíble experiencia! Las cataratas son impresionantes, el tour estuvo muy bien organizado y los guías fueron excelentes. Totalmente recomendado para toda la familia.",
    ...
    const reseña2 = new Reseña({
      ...
      calificacion: 5,
      comentario: "Torres del Paine es simplemente mágico. Los paisajes son de otro mundo y la experiencia de trekking fue inolvidable. Eso sí, hay que estar preparado físicamente.",
      verificada: true
    });
    await reseña2.save();
    ...
    const reseña3 = new Reseña({
      ...
      calificacion: 4,
      comentario: "Cartagena es hermosa, la ciudad amurallada tiene mucho encanto. La comida es deliciosa y la gente muy amable. Solo le resto una estrella por el calor extremo.",
      verificada: true
    });
    await reseña3.save();
